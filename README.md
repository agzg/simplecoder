# SimpleCoder
A CLI coding agent that can help you write code, navigate codebases, and complete various software engineering tasks. This agent includes advanced tool usage, Retrieval-Augmented Generation (RAG), reflections, context management, and task planning, etc.
...
## Authors
[@agzg](https://github.com/agzg) and [@prahee](https://github.com/prahee)
